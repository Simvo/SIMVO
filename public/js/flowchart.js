            ...
            for(var tabtitle in refreshedCourses)
            {
              ...
              for(var key in refreshedCourses[tabtitle])
              {
                if(refreshedCourses[tabtitle][key].length != 0){
                  ...
                  if(tabtitle == "Required") if(typeof response[3][key] !== "undefined") html += '<p class="group-desc">'+ response[3][key] +'</p>';
                  if(tabtitle == "Complementary") if(typeof response[4][key] !== "undefined") html += '<p class="group-desc">'+ response[4][key] +'</p>';
                  if(tabtitle == "Elective") if(typeof response[5][key] !== "undefined") html += '<p class="group-desc">'+ response[5][key] +'</p>';
